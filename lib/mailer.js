...
export const sendConfirmationEmail = async ({ to, name, programTitle, startDate, endDate }) => {
  ...
  // const cancelUrl = `https://localhost:3000/cancel/${registrationId}`;
  ...
  await transporter.sendMail({
    ...
    <div style="font-family: sans-serif; background: #f7f5f2; padding: 32px; border-radius: 8px; max-width: 600px; margin: auto;">
      ...
      <div style="text-align: center; margin-bottom: 24px;">
        <img src="https://yourdomain.com/logo.png" alt="Ninj Retreat Center" style="height: 60px;" />
      </div>
      ...
      <p style="text-align:center; margin-top: 16px;">
        <a href="#" style="color: #BB2D3B; text-decoration: underline;">
          Бүртгэлээ цуцлах
        </a>
      </p>
      ...
      <div style="text-align: center; margin: 20px 0;">
        <a href="https://yourdomain.com/contact" style="background-color: #107FBB; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold;">
          Холбогдох
        </a>
      </div>
